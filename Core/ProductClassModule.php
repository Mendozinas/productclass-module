 ...
 */
 ...
 namespace OxidEsales\ProductClassModule\Core;
 ...
 * @codeCoverageIgnore
 *
 * @package OxidEsales\ProductClassModule\Core
 */
class ProductClassModule extends BaseModule
{
    ...
    function __construct()
    {
        ...
        $moduleId = 'gmtproductclass';

        $this->setModuleData(
            [
                'id'          => $moduleId,
                'title'       => 'gmtproductclass',
                'description' => 'GMT Product Class',
            ]
        );

        $this->load($moduleId);

        Registry::set('gmtProductClassModule', $this);
    ...
    {
        if (self::_dbColumnExist('oxarticles', 'OXPRODUCTCLASS')) {
    ...
    protected function _dbColumnExist($sTable, $sColumn)
    {
        ...
        return DatabaseProvider::getDb()->getOne($sSql);
    }
    ...
    {
        if ($blUseModulePrefix) {
            $sModuleSettingName = 'gmtProductClass' . (string) $sModuleSettingName;
        }
    ...
    {
        return Registry::getConfig()->getModulesDir() . 'gmt/productclass/';
    }
